...
class Net(nn.Module):
    def __init__(self,lastLyr=32):
        ...
        self.dimRed = nn.Sequential(nn.Linear(2048,1024),nn.ReLU(),nn.Linear(1024,1024),nn.ReLU(),nn.Linear(1024,1024),
                                    nn.ReLU(),nn.Linear(1024,1024),nn.ReLU(),nn.Linear(1024,lastLyr))
